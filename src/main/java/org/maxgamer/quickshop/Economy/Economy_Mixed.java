/*
 * This file is a part of project QuickShop, the name is Economy_Mixed.java Copyright (C) Ghost_chu
...
public class Economy_Mixed implements EconomyCore {
  ...
  public boolean deposit(UUID name, double amount) {
    ...
    Bukkit.dispatchCommand(Bukkit.getConsoleSender(),
        MsgUtil.fillArgs(BaseConfig.mixedDepositCommand, Bukkit.getOfflinePlayer(name).getName(),
  ...
  public boolean withdraw(UUID name, double amount) {
    ...
    Bukkit.dispatchCommand(Bukkit.getConsoleSender(),
        MsgUtil.fillArgs(BaseConfig.mixedWithdrawCommand, Bukkit.getOfflinePlayer(name).getName(),
            String.valueOf(amount)));
    return true;
  }
