/*
 * This file is a part of project QuickShop, the name is WorldListener.java Copyright (C) Ghost_chu
...
public class WorldListener implements Listener {
  ...
  public void onWorldLoad(WorldLoadEvent e) {
    /*
     * ************************************* This listener fixes any broken world references. Such
     * as hashmap lookups will fail, because the World reference is different, but the world value
     * is the same. ************************************
     */
