...
public class QuickShopBuyer extends ContainerQuickShop implements ChestBuyer {
    ...
    public QuickShopBuyer(@NotNull ShopLocation shopLocation, double price, @NotNull ItemStacked item, @NotNull ShopModerator moderator, boolean unlimited, @NotNull ShopType type) {
