...
public class QuickShopLoader implements ShopLoader, Listener {
    ...
    public void onWorldUnload(WorldUnloadEvent event) {
        ...
        Shop.getManager().getLoadedShops().getOrDefault(world, Collections.emptyMap()).values().forEach(blockMap -> blockMap.values().forEach(shop -> Shop.getManager().unload(shop)));
    ...
    public void onChunkUnload(ChunkUnloadEvent e) {
        @Nullable
        Map<Long, BasicShop> inChunk = Shop.getManager().getLoadedShopsInChunk(e.getChunk());
    ...
    private static void exceptionHandler(@NotNull Throwable throwable, @Nullable ResultSet set) {
        ...
        if (set != null) {
            ...
            Object temp;
            List<Throwable> nested = Lists.newArrayList();
