/*
 * This file is a part of project QuickShop, the name is SubCommand_FetchMessage.java Copyright (C)
...
public class SubCommand_FetchMessage implements CommandProcesser {
  ...
  public void onCommand(@NotNull CommandSender sender, @NotNull String commandLabel,
    ...
    plugin.getServer().getScheduler().runTask(QuickShop.instance,
        () -> MsgUtil.flush((Player) sender));
  }
}
