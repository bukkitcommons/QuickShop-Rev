/*
 * This file is a part of project QuickShop, the name is ShopContainerWatcher.java Copyright (C)
...
public class ShopContainerWatcher extends BukkitRunnable {
  ...
  public void run() {
    ...
    while (shop != null) {
      ...
      if (System.currentTimeMillis() - beginTime > 45) { // Don't let quickshop eat more than 45 ms
                                                         // per tick.
        break;
      }
