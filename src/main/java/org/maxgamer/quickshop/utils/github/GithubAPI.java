/*
 * This file is a part of project QuickShop, the name is GithubAPI.java Copyright (C) Ghost_chu
...
public class GithubAPI {
  ...
  public ReleaseJsonContainer.AssetsBean getLatestRelease() throws Exception {
    String json = HttpRequest
        .get(new URL("https://api.github.com/repos/Ghost-chu/QuickShop-Reremake/releases/latest"))
