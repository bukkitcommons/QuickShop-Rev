/*
 * This file is a part of project QuickShop, the name is BukkitAPIWrapper.java Copyright (C)
...
public interface BukkitWrapper {
  ...
  void getChunkAt(@NotNull World world, @NotNull Block block,
      @NotNull CompletableFuture<Chunk> futureTask);
}
