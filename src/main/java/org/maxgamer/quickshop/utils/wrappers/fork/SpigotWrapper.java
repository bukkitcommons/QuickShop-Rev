/*
 * This file is a part of project QuickShop, the name is SpigotWrapper.java Copyright (C) Ghost_chu
...
package org.maxgamer.quickshop.utils.wrappers.fork;
...
public class SpigotWrapper implements BukkitWrapper {
  ...
  @Override
  public void getChunkAt(@NotNull World world, @NotNull Location location,
      @NotNull CompletableFuture<Chunk> futureTask) {
    futureTask.complete(world.getChunkAt(location));
  }

  @Override
  public void getChunkAt(@NotNull World world, int x, int z,
      @NotNull CompletableFuture<Chunk> futureTask) {
    futureTask.complete(world.getChunkAt(x, z));
  }

  @Override
  public void getChunkAt(@NotNull World world, @NotNull Block block,
      @NotNull CompletableFuture<Chunk> futureTask) {
