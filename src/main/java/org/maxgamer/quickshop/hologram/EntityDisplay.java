...
/**
 * Represents a shop display that have the actual entity. This is a wrapper of
 * the entity instead of its manager.
 */
@Data
...
public abstract class EntityDisplay implements GenericDisplay {
    ...
    public void tick() {
        ...
        /*
         * Location location = data.scheme(); boolean fix = data.type() ==
         * DisplayType.DROPPED_ITEM ? entity.getLocation().distance(location) > 0.6 :
         * entity.getLocation().equals(location);
         * 
         * if (fix) entity.teleport(location);
         */ // FIXME
    }
