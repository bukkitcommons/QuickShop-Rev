...
public class ArmorStandDisplay extends EntityDisplay implements Display {
    ...
    public void spawn() {
        ...
        /*
         * Location location = getDisplayLocation(); this.entity =
         * this.shop.getLocation().world().spawn(location, ArmorStand.class, armorStand
         * -> { // Set basic armorstand datas. armorStand.setGravity(false);
         * armorStand.setVisible(false); armorStand.setMarker(true);
         * armorStand.setInvulnerable(true); armorStand.setCollidable(false);
         * armorStand.setSmall(data.get(DisplayAttribute.SMALL, true));
         * armorStand.setArms(false); armorStand.setBasePlate(false);
