/*
 * This file is a part of project QuickShop, the name is VaultPermissionProvider.java Copyright (C)
...
public class VaultPermissionProvider implements PermissionProvider {
   ...
   */
  @Override
  public @NotNull PermissionInfomationContainer getDebugInfo(@NotNull CommandSender sender,
    ...
    return new PermissionInfomationContainer(sender, permission,
        api.getPrimaryGroup(null, offlinePlayer), null);
  }
}
