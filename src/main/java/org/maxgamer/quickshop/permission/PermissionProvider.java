/*
 * This file is a part of project QuickShop, the name is PermissionProvider.java Copyright (C)
...
public interface PermissionProvider {
   ...
   */
  @NotNull
  PermissionInfomationContainer getDebugInfo(@NotNull CommandSender sender,
