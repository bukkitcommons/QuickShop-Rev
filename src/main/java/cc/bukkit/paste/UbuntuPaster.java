/*
 * This file is a part of project QuickShop, the name is UbuntuPaster.java Copyright (C) Ghost_chu
...
public class UbuntuPaster implements PasteInterface {
  ...
  public String pasteTheText(@NotNull String text) throws Exception {
    ...
    String builder = "poster=" + "QuickShop Paster" + "&syntax=text" + "&expiration=month"
