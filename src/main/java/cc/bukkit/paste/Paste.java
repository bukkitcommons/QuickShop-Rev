    ...
    public @NotNull String genNewPaste() {
        ...
        try {
            ...
            switch (EconomyType.fromID(BaseConfig.economyType)) {
                case VAULT:
                    finalReport.append("Vault").append("%").append(((VaultEconProvider) economyCore).getProviderName());
                    break;
                case RESERVE:
        ...
        try {
            ...
            finalReport.append("\t\t\n").append(new String(Objects.requireNonNull(JavaUtils.inputStream2ByteArray(plugin.getDataFolder() + "/config.yml")), StandardCharsets.UTF_8)).append("\n");
            finalReport.append("\t*********************************\n");
            finalReport.append("\tmessages.json:\n");
            finalReport.append("\t\t\n").append(new String(Objects.requireNonNull(JavaUtils.inputStream2ByteArray(plugin.getDataFolder() + "/messages.json")), StandardCharsets.UTF_8)).append("\n");
            finalReport.append("\t*********************************\n");
            finalReport.append("\t*********************************\n");
            finalReport.append("\titemi18n.yml:\n");
            finalReport.append("\t\t\n").append(new String(Objects.requireNonNull(JavaUtils.inputStream2ByteArray(new File(plugin.getDataFolder(), "itemi18n.yml").getPath())), StandardCharsets.UTF_8)).append("\n");
            finalReport.append("\t*********************************\n");
            finalReport.append("\t*********************************\n");
            finalReport.append("\tenchi18n.yml:\n");
            finalReport.append("\t\t\n").append(new String(Objects.requireNonNull(JavaUtils.inputStream2ByteArray(new File(plugin.getDataFolder(), "enchi18n.yml").getPath())), StandardCharsets.UTF_8)).append("\n");
            finalReport.append("\t*********************************\n");
            finalReport.append("\t*********************************\n");
            finalReport.append("\tpotioni18n.yml:\n");
            finalReport.append("\t\t\n").append(new String(Objects.requireNonNull(JavaUtils.inputStream2ByteArray(new File(plugin.getDataFolder(), "potioni18n.yml").getPath())), StandardCharsets.UTF_8)).append("\n");
            finalReport.append("\t*********************************\n");
            finalReport.append("\t*********************************\n");
            ...
            try {
                ...
                finalReport.append("\t\t\n").append(new String(Objects.requireNonNull(JavaUtils.inputStream2ByteArray(new File(new File("."), "bukkit.yml").getPath())), StandardCharsets.UTF_8)).append("\n");
                finalReport.append("\t*********************************\n");
            } catch (Throwable th) {
                finalReport.append("\t*********************************\n");
                finalReport.append("\tbukkit.yml:\n");
            ...
            try {
                ...
                finalReport.append("\t\t\n").append(new String(Objects.requireNonNull(JavaUtils.inputStream2ByteArray(new File(new File("."), "spigot.yml").getPath())), StandardCharsets.UTF_8)).append("\n");
                finalReport.append("\t*********************************\n");
            } catch (Throwable th) {
                finalReport.append("\t*********************************\n");
                finalReport.append("\tspigot.yml:\n");
            ...
            try {
                ...
                finalReport.append("\t\t\n").append(new String(Objects.requireNonNull(JavaUtils.inputStream2ByteArray(new File(new File("."), "paper.yml").getPath())), StandardCharsets.UTF_8)).append("\n");
                finalReport.append("\t*********************************\n");
            } catch (Throwable th) {
                finalReport.append("\t*********************************\n");
                finalReport.append("\tpaper.yml:\n");
        ...
        try {
            ConfigurationSection configurationSection = QuickShop.instance().getConfigurationManager().get(BaseConfig.class).conf().getConfigurationSection("database");
            report = report.replaceAll(Objects.requireNonNull(configurationSection).getString("user"), "[PROTECTED]");
