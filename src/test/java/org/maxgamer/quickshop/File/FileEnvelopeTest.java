...
public class FileEnvelopeTest {
  ...
  @Test
  void saveToString() {
    System.out.println(json.saveToString());
  ...
  @Test
  void get() {
    assertEquals("{0}", json.get("signs.item"));
    assertEquals("{0}", yaml.get("signs.item"));
  }
  ...
  void getString() {
    ...
    assertEquals("&aSuccessfully removed all staff for your shop.", optionalS.get());
    assertEquals("&aSuccessfully removed all staff for your shop.", optionalSS.get());
  }
  ...
  void getWithFallback() {
    assertEquals("&aSuccessfully removed all staff for your shop.",
  ...
  @Test
  void getOrSet() {
    assertEquals("test", json.getOrSet("test.test123", "test"));
    assertEquals("test", yaml.getOrSet("test.test123", "test"));
    assertEquals("test", json.getOrSet("test.test123", "test"));
    assertEquals("test", yaml.getOrSet("test.test123", "test"));
  }
  ...
  @Test
  void getStringList() {
    assertEquals(test, json.getStringList("test.list"));
    assertEquals(test, yaml.getStringList("test.list"));
  }

  @Test
  void getInt() {
    assertEquals(13, json.getInt("test.int"));
    assertEquals(13, yaml.getInt("test.int"));
  }

  @Test
  void getDouble() {
    assertEquals(1, json.getDouble("test.short"));
    assertEquals(1, yaml.getDouble("test.short"));
  }

  @Test
  void getLong() {
    assertEquals(1, json.getLong("test.short"));
    assertEquals(1, yaml.getLong("test.short"));
  }

  @Test
  void getByte() {
    assertEquals((byte) 1, json.getByte("test.short"));
    assertEquals((byte) 1, yaml.getByte("test.short"));
  }

  @Test
  void getShort() {
    assertEquals((short) 1, json.getShort("test.short"));
    assertEquals((short) 1, yaml.getShort("test.short"));
  }

  @Test
  void getBoolean() {
    assertTrue(json.getBoolean("test.boolean"));
    assertTrue(yaml.getBoolean("test.boolean"));
  }
  ...
  @Test
  void getSection() {
    assertTrue(() -> !(json.getSection("test.section") instanceof MckFileConfiguration));
    assertTrue(() -> !(yaml.getSection("test.section") instanceof MckFileConfiguration));
  }

  @Test
  void getOrCreateSection() {
    assertTrue(() -> !(json.getOrCreateSection("test.section") instanceof MckFileConfiguration));
    assertTrue(() -> !(yaml.getOrCreateSection("test.section") instanceof MckFileConfiguration));
  }
